        ...
        <div class="container">
            <section class="agreement-complete">
                <div class="section-header">
                    ...
                    <ol class="step-list">
                        <li>
                            <div>
                                <p class="icon-img">
                                    <img src="/mobile/assets/images/sub/icon_step01.png" alt="step01">
                                </p>
                                약관동의
                            </div>
                        </li>
                        ...
                        <li class="active">
                            <div>
                                <p class="icon-img">
                                    <img src="/mobile/assets/images/sub/icon_step03_active.png" alt="step03">
                                </p>
                                가입완료
                            </div>
                        </li>
                ...
                <div class="section-content">
                    ...
                    <figure>
                        <img src="/mobile/assets/images/customer/img_success.png" alt="">
                    </figure>
