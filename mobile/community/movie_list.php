        ...
        <article class="movie-list">
            <div class="container">
                <div class="article-header">
                    <figure>
                        <img src="/mobile/assets/images/community/none_img_qna_list.jpg" alt="">
                    </figure>
                </div>
                <div class="article-content">
                    <ul class="row">
                        <li class="col-xs-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/assets/images/community/img_movie01.jpg" alt="">
                        ...
                        <li class="col-xs-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/assets/images/community/img_movie02.jpg" alt="">
