        ...
        <article class="today-talk">
            <div class="container">
                ...
                <div class="article-header">
                    <h3><img src="/mobile/assets/images/community/logo.gif" alt="앙쥬 로고"></h3>
                    <p>
                        이거 만큼은 어느 맛집 못지 않다! 앙쥬맘이 가장 잘하는
                        요리 자랑해보아요~ 앙쥬맘이 가장 잘하는 요리 자랑해보아요~
                    </p>
                    <figure>
                        <img src="/mobile/assets/images/community/img_today_talk.jpg" alt="">
                    </figure>
                </div>
                <div class="article-content">
                    ...
                    <div class="write-form">
                        <form action="#">
                            <figure>
                                <img src="/mobile/assets/images/community/img_user_none_profile.png" alt="">
                            </figure>
                            <div class="writing">
                    ...
                    <div class="banner">
                        <a href="#">
                            <figure>
                                <img src="/mobile/assets/images/community/talk_none_banner.jpg" alt="">
                            </figure>
                        </a>
                    </div>
                    <div class="talk-list">
