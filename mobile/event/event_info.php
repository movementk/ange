                ...
                <div class="section-content">
                    <article class="tab-menu">
                        <div class="tab-list-2">
                            <ul>
                                <li class="active"><a href="/mobile/event/event_info.php">상세 정보</a></li>
                                <li>
                                    <a href="/mobile/event/event_applicant.php">신청자한마디</a>
                                </li>
                                <li><a href="/mobile/event/event_review.php">체험후기</a></li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <figure>
                                <img src="/mobile/assets/images/event/img_event_info_none.jpg" alt="">
                            </figure>
                        </div>
                    </article>
                </div>
