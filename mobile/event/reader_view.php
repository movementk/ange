...
<body class="sub event"><!-- 폴더별 클래스명 추가 -->
    ...
    <div class="page-header">
        ...
        <div class="btn-controls">
            <a href="/mobile/event/prizewinner_list.php" class="prev">
                <i class="icon-left-open-big">
                    <span class="sr-only">이전 페이지</span>
                </i>
            </a>
            <a href="/mobile/event/event_list.php" class="next">
            ...
            <section>
                <div class="section-header">
                   <div class="row">
                        <div class="col-xs-5">
                            <figure>
                                <img src="/mobile/assets/images/event/img_reader_view01.jpg" alt="">
                            </figure>
                        </div>
                        <div class="col-xs-7">
                            <div class="details">
